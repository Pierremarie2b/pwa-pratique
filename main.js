...
function loadTechnologies(technos) {
    fetch('https://us-central1-pwa-technos-giancoli.cloudfunctions.net/getTechnos')
        .then(response => {
            response.json()
                .then(technos => {
...
if(navigator.serviceWorker) {
    ...
    navigator.serviceWorker
        ...
        .then(registration =>{
            ...
            const publicKey = "BMiXT8wWyxhLUJm9i2rUe5lFbkwzAQe3IPxhVwM7Phs8qGLzCue_0K1tk1HuBmV_Co4l39xPW4ymZSDFhBd2xzo";
